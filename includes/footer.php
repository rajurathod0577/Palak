...
<h3>Palak Jewellers</h3>
     ...
     <div class="module-body m-t-20">
        ...
        <a href="https://wa.link/w3y0xk" class='active' target="_blank"><i class="icon fa fa-whatsapp"></i></a>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(+91) 8454831534<br>(+91) 8356947093</p>
                </div>
            </li>
              ...
              <li class="media">
                <div class="pull-left">
                     <span class="icon fa-stack fa-lg">
                     <a href="mailto:rajurathod577@gmail.com">
                      <i class="fa fa-circle fa-stack-2x"></i>
                ...
                <div class="media-body">
                    <span><a href="mailto:rajurathod577@gmail.com">rajurathod577@gmail.com</a></span>
                </div>
            </li>
