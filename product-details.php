...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="assets/css/rateit.css"> <!--rateit.js-->
...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp"> <!-- Animate.css-->
...
<div class="sidebar-widget hot-deals wow fadeInUp"> <!-- Animate.css-->
...
?>
			<div class='col-md-9'>
				<div class="row  wow fadeInUp"> <!-- Animation-->
...
<div class="stock-container info-container m-t-10">
				...
				<div class="product-tabs inner-bottom-xs  wow fadeInUp"> <!-- Animate.css-->
					<div class="row">
						<div class="col-sm-3">
...
<?php $cid=$row['category'];
			$subcid=$row['subCategory']; } ?>
				<!-- ============================================== UPSELL PRODUCTS ============================================== -->
<section class="section featured-product wow fadeInUp"><!-- Animate.css-->
